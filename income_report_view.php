...
if(isset($_POST["submit_income_report"])){
    ...
    $weekly1 = $_POST["weekly"];
    $weekly2 = $_POST["weekly2"];
...
$query = "SELECT * FROM income_tbl INNER JOIN branch ON income_tbl.branch_id = branch.branch_id                 INNER JOIN items ON income_tbl.item_id = items.item_id INNER JOIN brand ON                              income_tbl.brand_id = brand.brand_id INNER JOIN admin_user ON income_tbl.receiver_id =                  admin_user.admin_id WHERE income_tbl.for_pullout = '0' AND income_tbl.date BETWEEN '".$weekly1."'         AND '".$weekly2."'";
...
$pdf->SetFont("Arial","B","12");
$pdf->Cell(0,10,"Incoming Report's Between ($weekly1 - $weekly2)" ,1,1,"C");
