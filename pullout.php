  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb" style="background-color: #5d0404;">
        ...
        <li class="breadcrumb-item active" style="color: white;">Pullout</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-upload"></i> Pullout Item</div>
        <div class="card-body">
            <div class="container">
                <form method="post" action="functions.php?pull_id=<?php echo $_GET['id']; ?>
                &serial=<?php echo $serial; ?>&lrwc=<?php echo $lrwc; ?>&trans=<?php echo $trans; ?>">       
                    <div class="row">
                    ...
                    <input type="submit" value="Pullout" name="pullout" class="btn btn-pogi btn-md" style="float:right;">
                </form>
            </div>
        </div>
