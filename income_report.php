  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb" style="background-color: #5d0404;">
        ...
        <li class="breadcrumb-item active" style="color: white;">Incoming Reports Sort by Date</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Incoming Reports</div>
        <div class="card-body">
            <div class="container">
                <form action="income_report_view.php" method="post">
                    <div class="row">
                        <div class="col-md-4"> 
                        ...
                        <div class="col-md-2">                            
                            <input class="btn btn-pogi" name="submit_income_report" value="View" type="submit" required>
                        </div>
                    </div>
                </form>
            </div>
