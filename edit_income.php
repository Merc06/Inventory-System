  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="container">
                <form method="post" action="functions.php?pass_id=<?php echo $_GET['id']; ?>&serial=<?php echo $serial;?>&lrwc=<?php echo $lrwc; ?>">       
                    <div class="row">
                    ...
                    <input type="submit" value="Save" name="edit" class="btn btn-pogi btn-md" style="float:right;">
                </form>
            </div>
        </div>
      </div>
